...
void protocol_bm(const int i, const Element &delta, const Polynomial &lambda,
                 const int &l, const Polynomial &b, std::false_type) {}

template <typename Polynomial,
          typename Element = typename Polynomial::element_type>
void protocol_bm(const int i, const Element &delta, const Polynomial &lambda,
                 const int &l, const Polynomial &b, std::true_type) {
